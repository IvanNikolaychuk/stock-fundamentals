...
public class PECompanyPropertyCreatorTest {
    ...
    public void avg_6_pe_property() {
        ...
        doReturn(properties).when(companyPropertyRepository).find(eq(TICKER), eq(EPS));
    ...
    public void last_pe_property() {
        doReturn(singletonList(epsProperty(2017, "1"))).when(companyPropertyRepository).find(eq(TICKER), eq(EPS));
    ...
    public void allPropertiesAreNull() {
        doReturn(singletonList(epsProperty(2017, null))).when(companyPropertyRepository).find(eq(TICKER), eq(EPS));
